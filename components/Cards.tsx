  ...
  return (
    <TouchableOpacity onPress={onPress} className="flex  flex-col items-start w-60 h-80 relative">
      ...
      <View className="flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute top-5 right-5 gap-2">
        ...
        <Text className="text-base font-rubik-bold text-primary-300 ml-0.5">4.4</Text>
      </View>
      <View className="flex flex-col items-start  absolute bottom-5 inset-x-5">
        <Text className="text-xl font-rubik-extraBold text-white" numberOfLines={1}>
          Modern Apartment
        </Text>
        <Text className="text-base font-rubik text-white mt-2">22 W 15th St,New York</Text>

        <View className="flex flex-row items-center  justify-between w-full">
          <Text className="text-xl font-rubik-extraBold text-white mt-2">$2,500</Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex flex-col mt-2">
        ...
        <Text className="text-xs font-rubik text-black ">22 W 15th St,New York</Text>
